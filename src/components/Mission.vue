<template>
  <section>
     <header>
       <!--Compteur pour les notifications-->
    <div class="mission compteur">
      <span ><strong>{{ compteur}}</strong>Mission (s) en ligne non faite (s)</span>
...
<!-- partie qui renseigne le tri -->
        ...
        <div class="col-4 icon-container">
          <button>
            <i class="fas fa-hourglass-half">
              <a href="#" :class="{selected: filter === 'todo'}" @click.prevent="filter = 'todo'">Disponible</a>
            </i>
          </button>
        </div>
        <div class="col-4 icon-container">
    ...
    <main><!--Debut ul li la class view c'est pour le back end-->
    ...
    <div class="add-button">
     ...
     <footer class="footer">
        ...
        <div class="col-4 icon-container">
          <ul>
            <li>
              <a href="pageinterprete.html">pageinterprete
        ...
        <div class="col-4 icon-container">
          <ul>
            <li><a href="profil.html">profil<i class="fas fa-user"></i></a></li>
          </ul>
        </div>

        <div class="col-4 icon-container">
          <ul>
            <li><a href="option.html">option<i class="fas fa-sliders-h"></i>
              </a>
            </li>
          </ul>
        </div>
